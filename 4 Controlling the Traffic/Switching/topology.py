...
def run():
    ...
    # Create mininet topology and connect to remote controller
    topo = MininetTopology()
    net = Mininet(topo=topo, link=TCLink, switch=OVSSwitch, controller=partial( RemoteController, ip='127.0.0.1', port=6633 ))
    net.start()
